    ...
    return (
        <>
            {showInventoryTransfer && (
                <InventoryTransfer
                    server={server}
                    onClose={() => setShowInventoryTransfer(false)}
                />
            )}
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                            <button
                                ...
                                className="p-1.5 bg-gray-800 hover:bg-gray-700 rounded transition-colors group"
                                title="Transfer Items"
                            >
                                <GridIcon className="w-5 h-5 text-gray-400 group-hover:text-blue-400" />
                            </button>
                            <div className="flex items-center space-x-2">
